...
\usepackage{enxumitem}       % for configuring list environments
...
\definecolor{cvsectioncolor}{HTML}{80CC66}
...
\cvitem{
    ...
    Piscina Universitaria Perugia, Perugia, Italy
}
...
\cvitem{
    ...
    Soggiorni TIM: Colleverde Summer Camps, Colle Umberto, Perugia, Italy
}
